...
#ifndef ANTOURAGEWIDGET_SWIFT_H
#define ANTOURAGEWIDGET_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AntourageWidget",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15AntourageWidget19EmptyDataSourceView")
...
SWIFT_CLASS("_TtC15AntourageWidget10FooterView")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC15AntourageWidget12GradientView")
...
SWIFT_CLASS("_TtC15AntourageWidget10IQTextView")
...
SWIFT_CLASS("_TtC15AntourageWidget13LatestComment")
...
@interface MessageMO (SWIFT_EXTENSION(AntourageWidget))
...
SWIFT_CLASS("_TtC15AntourageWidget14ModernAVPlayer")
...
@interface PollMO (SWIFT_EXTENSION(AntourageWidget))
...
SWIFT_CLASS("_TtC15AntourageWidget17PollTableViewCell")
...
SWIFT_CLASS("_TtC15AntourageWidget15SeekPaddingView")
...
@interface UIBarButtonItem (SWIFT_EXTENSION(AntourageWidget))
...
@interface UIImage (SWIFT_EXTENSION(AntourageWidget)) <NSDiscardableContent>
...
@interface UIViewController (SWIFT_EXTENSION(AntourageWidget)) <ASWebAuthenticationPresentationContextProviding>
...
@interface VideoContentMO (SWIFT_EXTENSION(AntourageWidget))
...
SWIFT_CLASS("_TtC15AntourageWidget9WebSocket")
...
@interface WebSocket (SWIFT_EXTENSION(AntourageWidget))
...
SWIFT_PROTOCOL("_TtP15AntourageWidget17WebSocketDelegate_")
@protocol WebSocketDelegate
...
SWIFT_CLASS("_TtC15AntourageWidget10WidgetView")
