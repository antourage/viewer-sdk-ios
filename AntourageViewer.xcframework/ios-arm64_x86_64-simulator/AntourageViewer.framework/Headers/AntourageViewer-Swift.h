...
#ifndef ANTOURAGEVIEWER_SWIFT_H
#define ANTOURAGEVIEWER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AntourageViewer",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15AntourageViewer19EmptyDataSourceView")
...
SWIFT_CLASS("_TtC15AntourageViewer10FooterView")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC15AntourageViewer12GradientView")
...
SWIFT_CLASS("_TtC15AntourageViewer10IQTextView")
...
SWIFT_CLASS("_TtC15AntourageViewer13LatestComment")
...
@interface MessageMO (SWIFT_EXTENSION(AntourageViewer))
...
SWIFT_CLASS("_TtC15AntourageViewer14ModernAVPlayer")
...
@interface PollMO (SWIFT_EXTENSION(AntourageViewer))
...
SWIFT_CLASS("_TtC15AntourageViewer17PollTableViewCell")
...
SWIFT_CLASS("_TtC15AntourageViewer15SeekPaddingView")
...
@interface UIBarButtonItem (SWIFT_EXTENSION(AntourageViewer))
...
@interface UIImage (SWIFT_EXTENSION(AntourageViewer)) <NSDiscardableContent>
...
@interface VideoContentMO (SWIFT_EXTENSION(AntourageViewer))
...
SWIFT_CLASS("_TtC15AntourageViewer9WebSocket")
...
@interface WebSocket (SWIFT_EXTENSION(AntourageViewer))
...
SWIFT_PROTOCOL("_TtP15AntourageViewer17WebSocketDelegate_")
@protocol WebSocketDelegate
...
SWIFT_CLASS("_TtC15AntourageViewer10WidgetView")
